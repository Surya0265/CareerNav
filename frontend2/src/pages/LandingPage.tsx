        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-white pb-6">AI-powered career navigation for the next generation of professionals.<br />
                Personalized job matching, skill gap analysis, and curated learning resources.<br />
                Empowering you to achieve your career goals with confidence and clarity.
              </p>
            </div>
          </div>
          <div className="border-t border-border mt-2 pt-2 text-center text-muted-foreground w-full absolute left-0 right-0">
